...
while ($row = mysqli_fetch_assoc($sql)) {
  ...
  (strlen($result) > 28) ? $msg = mb_substr($result, 0, 19) . '...' : $msg = $result;
  // $msg = mb_strlen($result, 'utf-8') > 28 ? mb_substr($result, 0, 19, 'utf-8').'...' : $result;
  // ($outgoing_id == $row2['outgoing_msg_id']) ? $you = "Вы: " : $you = "";
  ($row2 && $outgoing_id == $row2['outgoing_msg_id']) ? $you = "Вы: " : $you = "";
